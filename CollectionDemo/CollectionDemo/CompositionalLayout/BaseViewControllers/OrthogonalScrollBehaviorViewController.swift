    ...
    func createLayout() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout(sectionProvider: {
            ...
            let trailingGroup = NSCollectionLayoutGroup.vertical(
                layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.3), heightDimension: .fractionalHeight(1.0)),
            ...
            let containerGroup = NSCollectionLayoutGroup.horizontal(
                layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(containerGroupFractionalWidth), heightDimension: .fractionalHeight(0.4)),
...
extension OrthogonalScrollBehaviorViewController {
    ...
    func configureDataSource() {
        ...
        let supplementaryRegistration = UICollectionView.SupplementaryRegistration<TitleSupplementaryView>(elementKind: OrthogonalScrollBehaviorViewController.headerElementKind) { supplementaryView, elementKind, indexPath in
